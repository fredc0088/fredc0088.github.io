...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/fcocco", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/fredc0088", "_blank");
        },
      },{
        id: 'social-gitlab',
        title: 'GitLab',
        section: 'Socials',
        handler: () => {
          window.open("https://gitlab.com/federico.cocco", "_blank");
        },
      },{
        id: 'social-wikipedia',
        title: 'Wikipedia',
        section: 'Socials',
        handler: () => {
          window.open("https://wikipedia.org/wiki/User:Feelingfuzzy", "_blank");
        },
      },{
        id: 'social-telegram',
        title: 'telegram',
        section: 'Socials',
        handler: () => {
          window.open("https://telegram.me/ProfInhuman", "_blank");
        },
      },{
