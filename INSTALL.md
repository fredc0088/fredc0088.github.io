...
Starting version [v0.3.5](https://github.com/alshedivat/al-folio/releases/tag/v0.3.5), **al-folio** will automatically re-deploy your webpage each time you push new changes to your repository **master branch**! :sparkles:
...
4. Make changes to your master branch, commit, and push!
...
3. Make changes to your master branch, commit, and push!
...
3. Make any other changes to your webpage, commit, and push to your master branch. This will automatically trigger the **Deploy** action.
